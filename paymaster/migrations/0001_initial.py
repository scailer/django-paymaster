...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'paymaster_invoice', (
            ('number', self.gf('django.db.models.fields.CharField')(max_length=17, primary_key=True)),
    ...
    models = {
        u'paymaster.invoice': {
            ...
            'number': ('django.db.models.fields.CharField', [], {'max_length': '17', 'primary_key': 'True'}),
